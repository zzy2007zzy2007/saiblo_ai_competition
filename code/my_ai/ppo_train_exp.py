...
def compute_pos_hard_loss(
    ...
    Combined with compute_pos_mse_loss (trust-region), the MSE should keep
    the map from collapsing, while this term actually optimizes positions.
    """
    POS_SCALE = 100.0
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--lambda-pos-hard", type=float, default=0.0,
