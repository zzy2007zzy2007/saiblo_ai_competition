...
#
# 用法:
#   bash code/my_ai/az_intent/run_az_batches.sh [总batch数] [起始batch] [init_checkpoint]
# 例（从 az_r3 继续跑 6 个 batch，batch 编号 9~14）:
#   bash code/my_ai/az_intent/run_az_batches.sh 6 9 training_history/az_intent/az_r3.pt
set -u
...
prev="$INIT"
echo "[run] total batches=$N_BATCHES start=$START_BATCH init=$prev data=$DATA"
