"""Quick re-test gen_15 top1 vs ExampleAI (10 games)."""
import sys
...
def _worker(seed):
    ...
    return 1.0 if h_me > h_opp else (0.5 if h_me == h_opp else 0.0), h_me, h_opp
...
if __name__ == '__main__':
    ...
    print(f'gen_15 top1 vs ExampleAI (10 games):  {wins}/10 wins  {draws}/10 draws')
